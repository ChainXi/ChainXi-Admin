...
public class CacheConfiguration {
    ...
    public CacheBuilder cacheBuilderL1(RedisConnectionFactory connectionFactory,
        ...
        return new CacheBuilderRedisImpl(redisCacheWriter, redisCacheConfiguration);
    }
    ...
    public MultiLevelCacheManager multiCacheManager(CacheConfigSynchronizer configSynchronizer,
        ...
        initialCacheConfiguration.put(CacheKeyConstants.DATA_PERMISSION_TABLE_KEY, Arrays.asList(-1, 600000));

        return new MultiLevelCacheManager(configSynchronizer,
                dataSynchronizer,
    ...
    @Bean
    public CacheDataChangedReceiver cacheDataChangedReceiver(RedisTemplate<Object,Object> redisTemplate,
            RedisMessageListenerContainer listenerContainer,
            MultiLevelCacheManager cacheManager) {
        return new CacheDataChangedReceiverRedisChannelImpl(redisTemplate,
                listenerContainer,
                cacheManager);
    }
}
