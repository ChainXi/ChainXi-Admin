...
public class GenUtils
{
     ...
     * 初始化表信息
     */
    public static void initTable(GenTable genTable, GenProperties properties)
    {
        genTable.setClassName(convertClassName(genTable.getTableName(),properties));
     ...
     * @return 类名
     */
    public static String convertClassName(String tableName,GenProperties properties)
    {
        boolean autoRemovePre = properties.getAutoRemovePre();
