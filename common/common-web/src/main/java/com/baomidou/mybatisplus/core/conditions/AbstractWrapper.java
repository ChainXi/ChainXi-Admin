...
public abstract class AbstractWrapper<T, R, Children extends AbstractWrapper<T, R, Children>> extends Wrapper<T>
    ...
    public Children ampersandEq(R column, Object ampersand, Object val) {
        return maybeDo(true, () -> appendSqlSegments(() ->
                columnToSqlSegment(column).getSqlSegment() + " & " +
                        ampersand, SqlKeyword.EQ, () -> formatParam(null, val)));
    }
    public Children likeIfPresent(R column, String val) {
    ...
    public Children inIfPresent(R column, Collection<?> values) {
    ...
    public Children inIfPresent(R column, Object... values) {
        if (ObjectUtil.isAllNotEmpty(values) && !ArrayUtil.isEmpty(values)) {
            return in(column, values);
        }
        return typedThis;
    ...
    public Children eqIfPresent(R column, Object val) {
    ...
    public Children neIfPresent(R column, Object val) {
        if (ObjectUtil.isNotEmpty(val)) {
    ...
    public Children gtIfPresent(R column, Object val) {
        if (val != null) {
    ...
    public Children geIfPresent(R column, Object val) {
        if (val != null) {
    ...
    public Children ltIfPresent(R column, Object val) {
        if (val != null) {
    ...
    public Children leIfPresent(R column, Object val) {
        if (val != null) {
    ...
    public Children betweenIfPresent(R column, Object val1,
            Object val2) {
    ...
    public Children betweenIfPresent(R column, Object[] values) {
        Object val1 = org.apache.commons.lang3.ArrayUtils.get(values, 0);
        Object val2 = org.apache.commons.lang3.ArrayUtils.get(values, 1);
